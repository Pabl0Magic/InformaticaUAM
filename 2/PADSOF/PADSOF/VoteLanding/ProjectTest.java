...
/**
 * Test for Project class with Junit
 * 
...
public class ProjectTest {
	...
	/**
	 * We expect the id 4 because in group test we initialize 3 social group (meaning they will wave the ids 1,2 and 3).
	 * Therefore the next id we expect is 4. 
	 */
	@Test
	...
	/**
	 * To verify setId we start a project with the constructor meaning that setId will put the id to 5 and
	 * then we call setId so the id will be 6.
	 */
	@Test
