    ...
    */    
    ...
    throws ServletException, IOException {        
		...
		try{
            ...
            bp.getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, getServletContext().getInitParameter("URLVisaDAOWSService"));
            ...
            ArrayList<PagoBean> pagos = (ArrayList<PagoBean>) dao.getPagos(idComercio);
            ...
            System.err.println("ERROR: Error recibiendo pago.\n");
            return;
        }
        return;       
    }      
