...
public class ComienzaPago extends ServletRaiz {
    ...
    /**
     * Parametro que indica el nombre de la instancia 
     */
    public final static String PARAM_INSTANCIA = "instancia";

    /**
     * Parametro que indica la ip de la instancia
     */
    ...
    */
    private boolean validaParametros(PagoBean pago) {
        ...
        if (esBlancoONulo(pago.getInstancia())) {
            errorLog("[WARNING] Incorrecta instancia:" + pago.getInstancia());
            return false;   
        }

        if (esBlancoONulo(pago.getIp())) {
            errorLog("[WARNING] Incorrecta ip:" + pago.getIp());
            return false;   
        }
    ...
    * @see ssii2.visa.PagoBean 
    */
    private PagoBean creaPago(HttpServletRequest request) throws UnknownHostException {
