...
#SECRET_KEY = 'django-insecure-rc^4!%i6t+7q3nkjb^$me*x136%@^h5_)%g)*65xtbl&7m1isf'
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    default = 'django-insecure-rc^4!%i6t+7q3nkjb^$me*x136%@^h5_)%g)*65xtbl&7m1isf'
    )
...
NEON_URL = 'postgres://mbernuy:Tvx7Ds8kKcyr@ep-wild-frog-307801.eu-central-1.aws.neon.tech/psi'
...
LOGOUT_REDIRECT_URL = 'home_unsigned'
